...
module.exports = {
    // ===== BOT CORE SETTINGS =====
    SESSION_ID: process.env.SESSION_ID || "IK~utBm3CwY#aftbLBsi3sDqpxss82MRGF90elntcp1pPI0L_6yeVz0",  // Your bot's session ID (keep it secure)
    PREFIX: getConfig("PREFIX") || ".",  // Command prefix (e.g., "., / ! * - +")
    CHATBOT: getConfig("CHATBOT") || "on", // on/off chat bot 
    BOT_NAME: process.env.BOT_NAME || getConfig("BOT_NAME") || "LILMANU-MD",  // Bot's display name
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "24160206120",  // Owner's WhatsApp number
    OWNER_NAME: process.env.OWNER_NAME || getConfig("OWNER_NAME") || "LIL MANU",           // Owner's name
    DEV: process.env.DEV || "24160206120",                     // Developer's contact number
    DEVELOPER_NUMBER: '24160206120@s.whatsapp.net',            // Developer's WhatsApp ID
    ...
    DESCRIPTION: process.env.DESCRIPTION || "*© CREATER LIL MANU*",  // Bot description
